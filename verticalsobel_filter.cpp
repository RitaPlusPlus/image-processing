...
QImage verticalSobelFilter::verticalSobelGradientFilter(const  unsigned char* imageData,const int width, const int height,const QImage::Format f)
{
    const int c = 2;
    ...
    return applyVSFilter(imageData, width, height, f, 1, kernel, c+2 , &verticalSobelFilter::applyConv);
}// Vertical Sobel Filter kernel


QImage verticalSobelFilter::applyVSFilter(const unsigned char *imageData, const int width, const int height, const QImage::Format f, const int kernelRadius, const int kernel[], const double kernelParameter,
...
QColor verticalSobelFilter::applyConv(const unsigned char *imageData,const int width, const int height,
