...
QImage verticalSobelFilter::verticalSobelGradientFilter(const  uchar* imageData,const int width, const int height,const QImage::Format format)
{
    const int c = 2;
    ...
    return applyFilter(imageData, width, height, format, 1, kernel, c+2 , &verticalSobelFilter::applyConvolution);
}


QImage verticalSobelFilter::applyFilter(const uchar *imageData, const int width, const int height, const QImage::Format format, const int kernelRadius, const int kernel[], const float kernelParameter,
...
QColor verticalSobelFilter::applyConvolution(const uchar *imageData,const int width, const int height,
